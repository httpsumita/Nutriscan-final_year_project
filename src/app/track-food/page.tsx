...
export default function TrackFoodPage() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-sage-50 to-neutral-0">
      <div className="max-w-4xl mx-auto py-8 px-6">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-neutral-700">Track Food Intake</h1>
            <p className="text-neutral-500 text-sm mt-1">Log your daily meals and calories</p>
          </div>
          <Link
            href="/dashboard"
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl border border-neutral-200 shadow-sm p-6 mb-8">
              <div className="flex items-center gap-2 mb-6">
                ...
                <h2 className="text-lg font-semibold text-neutral-700">Add Food</h2>
              </div>
              ...
              {calorieEntries.length > 0 ? (
                <div className="space-y-3">
                  <h3 className="font-medium text-neutral-700 mb-4">Today's Food Log</h3>
